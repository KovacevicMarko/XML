...
public class PasswordStorage {
	...
	// metoda koja proveraca da li unesena lozinka odgovara snimljenoj
	 ...
	 public static boolean checkPassword(String formPassword, String userPassword, String userSalt)
	 {
		 try {
			return PasswordStorage.authenticate(formPassword, PasswordStorage.base64Decode(userPassword), PasswordStorage.base64Decode(userSalt));
